      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-20 py-12 sm:py-16 lg:py-24">
        ...
        <div className="mb-12 sm:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {skills.map((skill) => (
              <div key={skill.name} className="p-4 sm:p-6 bg-gray-50 dark:bg-white/5 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-white/50 hover:border-gray-300 dark:hover:border-white transition-all">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 sm:gap-4 justify-center">
            {technologies.map((tech) => (
              <span
                key={tech}
                className="px-3 sm:px-6 py-2 sm:py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/50 rounded-full text-gray-700 dark:text-gray-200 text-xs sm:text-sm font-medium hover:border-gray-400 dark:hover:border-white hover:shadow-md transition-all cursor-default"
              >
                {tech}
              </span>
            ))}
