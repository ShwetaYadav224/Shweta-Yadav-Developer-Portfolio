...
function Contact() {
  ...
  return (
    <section className="w-full bg-white dark:bg-[#0d161b] min-h-screen">
      {/* Contact Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:pr-8">
              ...
              <div className="text-center lg:text-left mb-6">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#152228] rounded-full mb-3 sm:mb-4 border border-[#0d161b] dark:border-white/30 shadow-sm">
                  <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                  <span className="text-xs sm:text-sm font-medium text-[#151f34] dark:text-gray-300">Get In Touch</span>
                </div>

                <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-[#151f34] dark:text-white mb-2 sm:mb-3 leading-tight">
                  Let's Connect
                </h1>

                <p className="text-sm sm:text-base lg:text-lg text-[#151f34]/80 dark:text-gray-300 max-w-md mx-auto lg:mx-0">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 lg:gap-4 mb-6 lg:mb-0">
                <a href="mailto:shweta2025y@gmail.com" className="flex flex-col lg:flex-row items-center lg:items-center gap-2 lg:gap-4 p-3 sm:p-4 bg-gray-50 dark:bg-white/5 rounded-lg sm:rounded-xl border border-[#151f34]/20 dark:border-white/50 hover:border-[#151f34]/40 dark:hover:border-white transition-colors text-center lg:text-left">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-lg bg-[#151f34]/10 dark:bg-white/10 flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-[#151f34] dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">Email</p>
                    <p className="text-xs sm:text-sm font-medium text-[#151f34] dark:text-white">shweta2025y@gmail.com</p>
                  </div>
                </a>

                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="flex flex-col lg:flex-row items-center lg:items-center gap-2 lg:gap-4 p-3 sm:p-4 bg-gray-50 dark:bg-white/5 rounded-lg sm:rounded-xl border border-[#151f34]/20 dark:border-white/50 hover:border-[#151f34]/40 dark:hover:border-white transition-colors text-center lg:text-left">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-lg bg-[#151f34]/10 dark:bg-white/10 flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-[#151f34] dark:text-gray-200" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm font-medium text-[#151f34] dark:text-white">Connect with me</p>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-6 lg:p-8 bg-gray-50 dark:bg-white/5 rounded-xl sm:rounded-2xl border border-[#151f34]/20 dark:border-white/50">
              <h2 className="text-base sm:text-lg lg:text-xl font-bold text-[#151f34] dark:text-white mb-4 lg:mb-6">Send a Message</h2>
