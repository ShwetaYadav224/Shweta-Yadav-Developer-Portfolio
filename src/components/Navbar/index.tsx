  ...
  return (
    <>
      ...
      <div className="fixed top-4 right-6 z-50 flex items-center gap-3">
        <Link to="/" className="text-lg font-bold text-gray-900 dark:text-white hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
          Shweta Yadav
        </Link>
          ...
          className={`absolute top-1 left-1
            ...
            ${
              isActive(link.path)
                ...
                : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-blue-100 dark:hover:bg-gray-700'
            }`}
        >
          {link.name}
        </Link>
